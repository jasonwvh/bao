...
from .agent import BayesianDeepAgent


AGENT = BayesianDeepAgent(cost=float(os.getenv("AGENT_COST", "5.0")), mc_samples=int(os.getenv("MC_SAMPLES", "15")))
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if self.path == "/a2a/capabilities":
            return self._send({"agent_id": AGENT.agent_id, "capabilities": ["flow_tabular", "uncertainty", "deep_inspection"], "cost": AGENT.cost})
        self.send_error(404)
